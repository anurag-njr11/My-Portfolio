    ...
    <Section id="about" title="About Me">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="glass-card rounded-2xl p-8 relative overflow-hidden border-white/5 bg-black/40 hover:border-primary-neon/10 transition-all duration-500">
            <Sparkles className="absolute top-4 right-4 text-primary-neon opacity-20" size={40} />
        ...
        <motion.div
          ...
          className="space-y-8"
        >
          <h3 className="text-3xl font-display font-medium text-white">Innovation with Purpose</h3>
